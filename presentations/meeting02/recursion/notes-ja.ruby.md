...
パフォーマンスに｛影響｝｛えいきょう｝を｛与｝｛あた｝えます。｛頻繁｝｛ひんぱん｝に
｛実行｝｛じっこう｝される｛条件｝｛じょうけん｝を｛上｝｛うえ｝にした
｛方｝｛ほう｝が｛良｝｛い｝いです。
...
｛後｝｛うし｝ろに｛追加｝｛ついか｝したら、`s0`と`s1`と`s2`の｛値｝｛あたい｝が
｛変更｝｛へんこう｝されてしまいます。なので、これはできません。
...
> ｛複雑｝｛ふくざつ｝になります。
> Haskellでは｛遅延評価｝｛ちえんひょうか｝を｛用｝｛もち｝いない｛時｝｛とき｝に
> ｛大切｝｛たいせつ｝です。
