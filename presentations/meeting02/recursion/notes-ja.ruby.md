...
｛終了｝｛しゅうりょう｝しない｛関数｝｛かんすう｝は｛危｝｛あぶ｝ないです。
この｛場合｝｛ばあい｝は`error`を｛使｝｛つか｝った｛方｝｛ほう｝が
｛良｝｛い｝いです。
...
｛定義｝｛ていぎ｝の｛条件｝｛じょうけん｝の｛順番｝｛じゅんばん｝は
パフォーマンスに｛影響｝｛えいきょう｝を｛与｝｛あた｝えます。
｛頻繁｝｛ひんぱん｝に｛実行｝｛じっこう｝される｛条件｝｛じょうけん｝を
｛上｝｛うえ｝にした｛方｝｛ほう｝が｛良｝｛い｝いです。
...
｛後｝｛うし｝ろに｛追加｝｛ついか｝したら、`s0`と`s1`と`s2`の
｛値｝｛あたい｝が｛変更｝｛へんこう｝されてしまいます。なので、これは
できません。
...
｛変更｝｛へんこう｝しないように、リストをコピーする｛必要｝｛ひつよう｝
があります。
...
> カリー｛化｝｛か｝のおかげで`lst`は｛必要｝｛ひつよう｝ないです。
...
> ｛持｝｛も｝っている｛方｝｛かた｝は｛末尾再帰｝｛まつびさいき｝を
> ｛知｝｛し｝っています。
> ｛他｝｛ほか｝の｛言語｝｛げんご｝にとっても｛大切｝｛たいせつ｝です。
> Haskellは｛遅延評価｝｛ちえんひょうか｝を｛用｝｛もち｝いているため
> ｛複雑｝｛ふくざつ｝になります。
> Haskellでは｛遅延評価｝｛ちえんひょうか｝を｛用｝｛もち｝いない
> ｛時｝｛とき｝に｛大切｝｛たいせつ｝です。
